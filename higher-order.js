...
//orders.map(element => element * orders.element.tax)
...
let bobFunction = purchases.filter(element => element.owner === "Bob")

let bobsTotal = bobFunction.reduce(function (acc, element){
